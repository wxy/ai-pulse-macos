...
enum I18n {
    static let zh: [String: String] = [
        ...
        "integrations.desc": "支持的工具和服务显示如下。配置后即可自动追踪 AI 花费，所有数据仅存储在本地。",
        "integrations.group_api_key_desc": "填入各 AI 服务商的 Key 以自动获取账户余额和用量。Key 在厂商官网生成，仅存储在本地，不提供 AI 服务访问。应用仅读取花费数据，不能使用 AI 服务。",
    ...
    static let en: [String: String] = [
        ...
        "integrations.desc": "Supported tools and services are shown below. Configure them to automatically track AI spending. All data stays on your machine.",
        "integrations.group_api_key_desc": "Enter keys from AI providers to automatically fetch account balance and usage. Keys are generated on each provider's website, stored locally only, and used solely to read spending data — they do not provide access to AI services.",
        ...
        "integrations.key_placeholder": "Enter key to fetch balance",
        ...
        "integrations.not_used": "Not Used",
