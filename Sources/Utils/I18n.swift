...
enum I18n {
    static let zh: [String: String] = [
        ...
        "integrations.group_api_key": "API 密钥",
        "integrations.group_subscription": "订阅",
        "integrations.group_log": "日志",
    ...
    static let en: [String: String] = [
        ...
        "integrations.group_api_key": "API Keys",
        "integrations.group_subscription": "Subscription",
        "integrations.group_log": "Log-based",
